...
! function(e) { "object" == typeof module && "object" == typeof module.exports ? e(require("jquery"), window, document) : e(jQuery, window, document) }(function(u, p, f, e) {
    ...
    t.prototype = {
        ...
        panStartHandler: function(e) {
            ...
            if (u(e.target).closest(".node").length || e.touches && 1 < e.touches.length) a.data("panning", !1);
                ...
                var o = 0,
                    r = 0;
                if (e.targetTouches) {
                    if (1 === e.targetTouches.length) o = e.targetTouches[0].pageX - t, r = e.targetTouches[0].pageY - i;
                    else if (1 < e.targetTouches.length) return
                } else o = e.pageX - t, r = e.pageY - i;
                a.on("mousemove touchmove", function(e) {
                    if (a.data("panning")) {
                        var t = 0,
                            i = 0;
                        if (e.targetTouches) {
                            if (1 === e.targetTouches.length) t = e.targetTouches[0].pageX - o, i = e.targetTouches[0].pageY - r;
                            else if (1 < e.targetTouches.length) return
                        } else t = e.pageX - o, i = e.pageY - r;
        ...
        startLoading: function(e) { var t = this.$chart; return (void 0 === t.data("inAjax") || !0 !== t.data("inAjax")) && (e.addClass("hidden"), e.parent().append('<i class="oci oci-spinner spinner"></i>').children().not(".spinner").css("opacity", .2), t.data("inAjax", !0), u(".oc-export-btn" + ("" !== this.options.chartClass ? "." + this.options.chartClass : "")).prop("disabled", !0), !0) },
        ...
        isInAction: function(e) { return -1 < e.children(".edge").attr("class").indexOf("oci-") },
        switchVerticalArrow: function(e) { e.toggleClass("oci-chevron-up").toggleClass("oci-chevron-down") },
        switchHorizontalArrow: function(e) {
            ...
            if (t.toggleSiblingsResp && (void 0 === t.ajaxURL || e.closest(".nodes").data("siblingsLoaded"))) {
                ...
                e.children(".leftEdge").toggleClass("oci-chevron-right", a).toggleClass("oci-chevron-left", !a), e.children(".rightEdge").toggleClass("oci-chevron-left", a).toggleClass("oci-chevron-right", !a)
            }
        },
        ...
        nodeEnterLeaveHandler: function(e) {
            ...
            "mouseenter" === e.type ? (n.length && (i = this.getNodeState(t, "parent").visible, n.toggleClass("oci-chevron-up", !i).toggleClass("oci-chevron-down", i)), s.length && (i = this.getNodeState(t, "children").visible, s.toggleClass("oci-chevron-down", !i).toggleClass("oci-chevron-up", i)), a.length && this.switchHorizontalArrow(t)) : t.children(".edge").removeClass("oci-chevron-up oci-chevron-down oci-chevron-right oci-chevron-left")
        },
        ...
        hEdgeClickHandler: function(e) {
            ...
            if (s.exist) {
                ...
                var r = i[0].id,
                    d = this.getNodeState(i, "parent").exist ? u.isFunction(n.ajaxURL.siblings) ? n.ajaxURL.siblings(i.data("nodeData")) : n.ajaxURL.siblings + r : u.isFunction(n.ajaxURL.families) ? n.ajaxURL.families(i.data("nodeData")) : n.ajaxURL.families + r;
        ...
        createGhostNode: function(e) {
            ...
            if (f.querySelector(".ghost-node")) t = n.closest(".orgchart").children(".ghost-node").get(0), i = u(t).children().get(0);
            else {
            ...
            var r = n.closest(".orgchart").css("transform").split(","),
                ...
                l = Math.abs(p.parseFloat(d ? r[0].slice(r[0].indexOf("(") + 1) : r[1]));
            ...
            } else a.dataTransfer.setDragImage && a.dataTransfer.setDragImage(t, h, c)
        },
        filterAllowedDropNodes: function(i) {
            var n = this.options,
                s = i.closest("[draggable]").hasClass("node"),
                a = i.closest(".nodes").siblings().eq(0).find(".node:first"),
                o = i.closest("table").find(".node");
            this.$chart.data("dragged", i).find(".node").each(function(e, t) { s && -1 !== o.index(t) || (n.dropCriteria ? n.dropCriteria(i, a, u(t)) && u(t).addClass("allowedDrop") : u(t).addClass("allowedDrop")) })
        },
        ...
        dropHandler: function(e) {
            ...
            if (i.hasClass("node")) {
                if (t.hasClass("allowedDrop")) {
                    var n = i.closest(".nodes").siblings().eq(0).children(),
                    ...
                    if (this.$chart.trigger(s, { draggedNode: i, dragZone: n.children(), dropZone: t }), !s.isDefaultPrevented()) {
                        if (t.closest("tr").siblings().length) {
                            var a = parseInt(t.parent().attr("colspan")) + 2,
                                o = '<i class="edge horizontalEdge rightEdge oci"></i><i class="edge horizontalEdge leftEdge oci"></i>';
                            ...
                            var r = i.closest("table").parent().siblings().find(".node:first");
                            1 === r.length && r.append(o)
                        } else t.append('<i class="edge verticalEdge bottomEdge oci"></i>').parent().attr("colspan", 2).parent().after('<tr class="lines"><td colspan="2"><div class="downLine"></div></td></tr><tr class="lines"><td class="rightLine"></td><td class="leftLine"></td></tr><tr class="nodes"></tr>').siblings(":last").append(i.find(".horizontalEdge").remove().end().closest("table").parent());
                        var d = parseInt(n.attr("colspan"));
                        if (2 < d) {
                            n.attr("colspan", d - 2).parent().next().children().attr("colspan", d - 2).end().next().children().slice(1, 3).remove();
        ...
        touchstartHandler: function(e) { this.touchHandled || e.touches && 1 < e.touches.length || (this.touchHandled = !0, this.touchMoved = !1, e.preventDefault()) },
        touchmoveHandler: function(e) {
            if (this.touchHandled && !(e.touches && 1 < e.touches.length)) {
                e.preventDefault(), this.touchMoved || (this.filterAllowedDropNodes(u(e.currentTarget)), this.touchDragImage = this.createDragImage(e, this.$chart.data("dragged")[0])), this.touchMoved = !0, this.moveDragImage(e, this.touchDragImage);
        ...
        touchendHandler: function(e) {
            if (this.touchHandled) {
                if (this.destroyDragImage(), this.touchMoved) {
                    ...
                    n.initMouseEvent("click", !0, !0, p, 1, i.screenX, i.screenY, i.clientX, i.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, 0, null), e.target.dispatchEvent(n)
                }
                this.touchHandled = !1
            }
        },
        ...
        destroyDragImage: function() { this.touchDragImage && this.touchDragImage.parentElement && this.touchDragImage.parentElement.removeChild(this.touchDragImage), this.touchDragImageOffset = null, this.touchDragImage = null },
        copyStyle: function(e, t) {
            if (["id", "class", "style", "draggable"].forEach(function(e) { t.removeAttribute(e) }), e instanceof HTMLCanvasElement) {
                var i = e,
                    n = t;
                n.width = i.width, n.height = i.height, n.getContext("2d").drawImage(i, 0, 0)
            }
            for (var s = getComputedStyle(e), a = 0; a < s.length; a++) {
                var o = s[a];
                o.indexOf("transition") < 0 && (t.style[o] = s[o])
            }
            t.style.pointerEvents = "none";
            for (a = 0; a < e.children.length; a++) this.copyStyle(e.children[a], t.children[a])
        },
        getTouchPoint: function(e) { return e && e.touches && (e = e.touches[0]), { x: e.clientX, y: e.clientY } },
        ...
        createNode: function(i) {
            var n = this.options,
                e = i.level;
            i.children && i[n.nodeId] && u.each(i.children, function(e, t) { t.parentId = i[n.nodeId] });
            var t = u("<div" + (n.draggable ? ' draggable="true"' : "") + (i[n.nodeId] ? ' id="' + i[n.nodeId] + '"' : "") + (i.parentId ? ' data-parent="' + i.parentId + '"' : "") + ">").addClass("node " + (i.className || "") + (e > n.visibleLevel ? " slide-up" : ""));
        ...
        buildHierarchy: function(e, t) {
            ...
            if (2 < Object.keys(t).length) {
                var d = this.createNode(t);
                n.verticalLevel && s >= n.verticalLevel ? e.append(d) : (a = u("<table>"), e.append(a.append(u("<tr/>").append(u("<td" + (r ? ' colspan="' + 2 * o.length + '"' : "") + "></td>").append(d)))))
            }
            if (r) {
        ...
        addChildren: function(e, t) { this.buildChildNode(e.closest("table"), t), e.children(".bottomEdge").length || e.append('<i class="edge verticalEdge bottomEdge oci"></i>'), e.find(".symbol").length || e.children(".title").prepend('<i class="oci ' + this.options.parentNodeSymbol + ' symbol"></i>'), this.isInAction(e) && this.switchVerticalArrow(e.children(".bottomEdge")) },
        ...
        addParent: function(e, t) { this.buildParentNode(e, t), e.children(".topEdge").length || e.children(".title").after('<i class="edge verticalEdge topEdge oci"></i>'), this.isInAction(e) && this.switchVerticalArrow(e.children(".topEdge")) },
        ...
        hideDropZones: function() { this.$chart.find(".allowedDrop").removeClass("allowedDrop") },
        showDropZones: function(e) { this.$chart.find(".node").each(function(e, t) { u(t).addClass("allowedDrop") }), this.$chart.data("dragged", u(e)) },
        processExternalDrop: function(e, t) { t && this.$chart.data("dragged", u(t)), e.closest(".node").triggerHandler({ type: "drop" }) },
        ...
        exportPNG: function(e, t) {
            ...
            if (!i && !n || s) p.navigator.msSaveBlob(e.msToBlob(), t + ".png");
                ...
                var o = ".oci-download-btn" + ("" !== this.options.chartClass ? "." + this.options.chartClass : "");
                a.find(o).length || a.append('<a class="oci-download-btn' + ("" !== this.options.chartClass ? " " + this.options.chartClass : "") + '" download="' + t + '.png"></a>'), a.find(o).attr("href", e.toDataURL())[0].click()
            }
        },
        export: function(t, i) {
            var n = this;
